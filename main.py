...
def parse_args():
    ...
    parser.add_argument("--file-path", default="shakespeare.txt")
    parser.add_argument("--iterations", type=int, default=2000)
    parser.add_argument("--batch-size", type=int, default=32)
    parser.add_argument("--block-size", type=int, default=128)

    parser.add_argument("--train-ratio", type=float, default=0.9)
    parser.add_argument("--train-path", type = str, default="shakespeare.txt")
...
def main():
    args = parse_args()
    data = make_data(train_ratio=args.train_ratio, path=args.file_path)
    model_state = {
    ...
    optimizer = args.optimizer
    model = DecoderOnlyModel(**model_state)
